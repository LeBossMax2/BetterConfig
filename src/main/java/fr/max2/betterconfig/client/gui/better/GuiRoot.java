...
import static fr.max2.betterconfig.client.gui.better.Constants.X_PADDING;
import static fr.max2.betterconfig.client.gui.better.Constants.Y_PADDING;
...
public class GuiRoot extends CompositeComponent
{
	...
	public GuiRoot(BetterConfigScreen screen, IComponent content)
	{
		...
		// Search bar
		this.searchField = new TextField(screen.getFont(), new TranslatableComponent(GuiTexts.SEARCH_BAR_KEY));
