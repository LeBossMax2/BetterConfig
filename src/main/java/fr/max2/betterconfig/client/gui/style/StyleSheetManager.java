...
public enum StyleSheetManager implements ResourceManagerReloadListener
{
	...
	private final Map<ResourceLocation, StyleSheet> cache = new HashMap<>();

	public Optional<StyleSheet> getStyleSheet(ResourceLocation sheetLocation) throws IOException
	{
